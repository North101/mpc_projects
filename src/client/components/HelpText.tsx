  ...
  <div className="help tldr">
    <section id="getting-started">
      ...
      <ol>
        ...
        <li>
          <p>
            If, after installing the extension, you don’t see the snowflake icon
            on the right side of your toolbar, click the puzzle piece icon to list
            your Chrome extensions and select the <strong>Pin</strong> icon next
            to MPC Project Helper to make the icon visible.
          </p>
        </li>
        <li>
          <p>
    ...
    <section id="website">
      ...
      <ol>
        ...
        <li>
          <p>
            A list of the project parts will come up. In many cases, there will
            only be a single option. But some projects may have multiple parts.
            Click the checkboxes to select the options you want. If not all
            checkboxes are selected by default, this means there are different
            versions of some parts of the project and you should choose the
            versions you prefer. Examples include alternate art version of the
            core set parallel investigators, and investigator minicards, which can
            be printed on mini-sized cards, or on regular cards which you can cut
            to size at home.
          </p>
        </li>
        <li>
      ...
      <ol>
        <li>
          <p>
            The <strong>Search</strong> box in the navigation allows you to search
            for projects by title.
          </p>
        </li>
        <li>
          <p>
            As you type, the list will be narrowed to projects including the
            string of characters you’ve typed in their name.
          </p>
        </li>
        <li>
          <p>
            To clear the search, click the <strong>x</strong> in the right of the
            box.
          </p>
        </li>
        <li>
          <p>
            Note that this only searches the title, not author, description, or
            other information.
          </p>
        </li>
      </ol>
      ...
      <ol>
        <li>
          ...
          <ul>
            ...
            <li>
              <p>
                The <strong>Tags</strong> filter contains information on the
                type(s) of content included in a project, such as Campaign,
                Standalone, Player Cards, and Investigators.
              </p>
            </li>
            <li>
              <p>
                The <strong>Status</strong> filter provides more information about
                the status of the project on Inexorable Fate. Pay special
                attention to projects tagged “Needs QA” or “Changes Pending.”
              </p>
              <ul>
                <li>
                  <p>
                    Projects that <strong>Need QA</strong> have not yet been
                    double-checked to ensure all cards have been uploaded
                    correctly, so it’s recommended you give them an extra check
                    before printing. (And let us know your findings!)
                  </p>
                </li>
                <li>
                  <p>
                    ...
                    can usually see more information about what the issues are by
                    clicking the info button (to the right of the card count).
                  </p>
                </li>
              </ul>
            </li>
        ...
        <li>
          <p>
            Filters can be selected from the filter dropdowns at the top, or by
            clicking on an author name, tag, etc. within a project to find other,
            similar content.
          </p>
        </li>
        <li>
    ...
    <section id="project-tab">
      ...
      <ol>
        <li>
          <p>
            Download the Arkham Horror homebrew or FFG PnP project(s) you want to
            print.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            Browse to the location of your project .json file, select it, and
      ...
      <p>
        The bottom right corner will show your total card count out of the maximum
        project size on MPC (612 for Arkham Horror-sized cards). If your total
        exceeds the max, the extension will automatically split it into multiple
        projects.
      </p>
      <ol>
        <li>
          <p>
            You may select additional <code>.json</code> files to combine multiple
            projects into one. Use the draggable handles on the left to reorder
            projects as desired.
          </p>
        </li>
        <li>
      ...
      <ol>
        <li>
          <p>
            When you are happy with the project, click <strong>Upload</strong>.
          </p>
        </li>
        <li>
          <p>
            Choose your desired print settings. The following settings are
            recommended for Arkham Horror LCG:
          </p>
          <p>
            <strong>Product:</strong> Custom Game Cards (63 x 88mm).
          </p>
          <p>
            <strong>Card Stock:</strong> S33 Superior Smooth (S33 is closest to
            FFG cards, but a little bit thicker. S30 Standard Smooth is slightly
            thinner but also acceptable, especially if you sleeve.)
          </p>
          <p>
            <strong>Project name:</strong> This is just for your own reference but
            may need to be shortened to fit MPC’s max length. At the very least
            you can remove (card count).json.
          </p>
        ...
        <li>
          <p>
            Now click <strong>Open Project (1/1)</strong>. This will open your
            project on MPC in a new tab. It may take a minute for the page to load
            so don&apos;t panic if initially all you see is a white screen.
          </p>
        </li>
        <li>
          <p>
    ...
    <ol>
      <li>
        <p>
          You will see you have leapfrogged to Step 5 of MPC&apos;s project design,
          bypassing the first four time-consuming steps.
        </p>
      </li>
      <li>
        <p>
          If you are loading a project that someone else created, even after
          giving the page time to load, you may see broken image icons instead of
          the card images you expect. This is due to the way MPC caches images —
          it is likely that if you printed the project it would print correctly
        ...
        <p>
          ...
          <strong>Edit</strong> on their saved project(s), allowing the images to
          reload. Once they have done this, you should be able to see the images
    ...
    <section id="images-tab">
      ...
      <ol>
        <li>
          <p>
            Prepare your images for upload by having one individual file for each
            unique card image.
          </p>
          <p>
        ...
        <li>
          <p>
            Ensure all cards are oriented vertically, and rotated so that the
            right edge of the front and the left edge of the back are both on the
            right. For Arkham Horror LCG horizontal cards (acts, agendas, and
            investigators), rotate the images so that lines of text on the front
            run from the bottom of the card to the top, and on the other side from
            top to bottom. (When previewing the front and back side by side, the
            bottoms of both faces should meet in the middle.)
          </p>
        </li>
        <li>
          <p>
            The suggested naming pattern is to prefix your cards with a card
            number followed by the card or project name and to suffix all card
            fronts with -a (or -1 or -front) and backs with -b (or -2 or -back.
            The identical names (except for the suffix) allow the project helper
            to automatically pair the front and back of each card. The numerical
            prefix ensures the extension will organize the cards in the desired
            order.
          </p>
        ...
        <li>
          <p>
            If you have a common front or back card (e.g. AHLCG encounter or
            player back) you can leave off the number and name your files like
            this:
          </p>
          <p>
            <code>
          ...
          <p>
            An image with the name <code>back</code> will automatically be
            recognized as the default back and assigned to any fronts without an
            identically named back. Or you can select a default back after
            importing with the extension.
          </p>
          <p>
            Since the extension only allows a single default back, if you have
            more than one back image that is used on a number of your cards, you
            have two choices:
          </p>
          <ol>
            <li>
              <p>
                You can choose the one you have the most of (often the encounter
                card back) to use as the default back and make a copy of others
                (like player card backs) for each card front requiring it.
              </p>
            </li>
            <li>
              <p>
        ...
        <li>
          <p>
            To print multiple, identical copies of a card, put a card count
            preceded by -x before the front/back flag:
          </p>
          <code>
            back.png
            <br />
          ...
          <br />
          <code>002-card-x2-a.png </code>
          <em>(prints two copies of card 002)</em>
          <br />
          <code>003-card-x5-a.png </code>
          <em>(prints five copies of card 003)</em>
          <br />
      ...
      <ol>
        ...
        <li>
          <p>
            Browse to the folder containing your images, use Command-A or Ctrl-A
            to select them all, and click <strong>Open</strong>.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            Review the list to confirm that card fronts and backs are paired up as
            desired.
          </p>
          <p>
            You may manually change card counts, delete unwanted cards, or set a
            default card front/back at this point.
          </p>
          <p>
            Check the card count in the bottom right corner to confirm you have
            the expected number of cards.
          </p>
        </li>
        <li>
          <p>
            Click <strong>Add</strong>. If any fronts and backs are paired
            incorrectly, you may choose a different image for either or both
            sides. You may also add additional images at this step, use the drag
            handles on the left to reorder cards, manually change card counts, or
            delete unwanted cards.
          </p>
        </li>
        <li>
          <p>
            Optionally click <strong>Preview</strong> to view your project, and x
        ...
        <li>
          <p>
            Click <strong>Upload</strong>. This may take a while for larger
            projects.
          </p>
        </li>
        <li>
          <p>
            When you see the <strong>Upload Success</strong> message, change the
            default project.json to a more descriptive name (retaining the .json
            extension). Click <strong>Save</strong>.
          </p>
        </li>
      </ol>
      <p>
      ...
      <ol>
        <li>
          <p>
            <strong>Combining projects:</strong> You may select additional .json
            project files to combine multiple projects into one. Use the draggable
            handles on the right to reorder projects as desired. The bottom right
            corner will show your total card count out of the maximum project size
            on MPC (612 for Arkham Horror-sized cards). If your total exceeds the
            max, the extension will automatically split it into multiple projects.
          </p>
        </li>
        <li>
          <p>
            <strong>Deleting and reordering cards:</strong> If you wish to remove
            cards from an existing project or reorder cards within the project,
            click the edit icon next to the project. Then use the trash icon to
            delete any cards you don’t need.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            If you are creating a project solely for the purpose of combining it
            with another project (for instance, if you changed a half-dozen cards
          ...
          <p>
            Instead, click only the green <strong>Upload</strong> button to upload
            the images to your MPC account without creating a project, then save
            your project file.
          </p>
          <p>
          ...
          <p>
            Click <strong>Export</strong> to create a third project which is a
            combination of your first two. Then, load the combined project, click
            the edit icon, and drag the cards from your second set to their
            desired positions. Re- <strong>Export</strong> your finalized project
            to save your finalized project file, then <strong>Upload</strong>.
          </p>
        </li>
      </ol>
      ...
      <ol>
        <li>
          <p>
            Click <strong>Open</strong> to view your project on MPC. It may take a
            minute for the page to load so don’t panic if all you see is a white
            screen, but this step will take substantially less time than the
            uploading step for images.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            If you wandered off for too long while the cards were uploading and
            the MPC page loads with only the header and footer but no cards after
            clicking <strong>Open</strong>, never fear; you won&apos;t have to redo the
            step or uploading each card image. Just go back to the extension and
            load the project file you just saved. You will then be able to open it
            successfully on MPC.
          </p>
        </li>
        <li>
          <p>
            Check the disclaimer box and <strong>Add to Cart</strong> to purchase
            or <strong>Add to Saved Projects</strong> to save for later or to
            allow others to order using your project file.
          </p>
        </li>
      </ol>
    </section>
