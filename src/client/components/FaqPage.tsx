        ...
        <div className='tldr col-md-9'>
          ...
          <Accordion flush id='faq-accordion' activeKey={hash} onSelect={onSelect}>
            ...
            <Accordion.Item eventKey='#refresh'>
              ...
              <Accordion.Body>
                <p>MPC&rsquo;s image caching expires frequently, and currently can&rsquo;t be refreshed automatically. If the images aren&rsquo;t loading, <a href='/help#contact'>contact us</a> (Discord is recommended for fastest support) and someone can refresh it for you.</p>
              </Accordion.Body>
            </Accordion.Item>
            ...
            <Accordion.Item eventKey='#sites'>
              ...
              <Accordion.Body>
                ...
                <p>Unfortunately the projects on Inexorable Fate are only compatible with MPC. If you need projects for other sites, <a href='/help#contact'>contact Coldtoes</a> for assistance.</p>
              </Accordion.Body>
            </Accordion.Item>
